...
for n = 1: NTRI
 ...
 FL = det(J)/6*[(1/8*P(LNODES(n,1))+1/8*P(LNODES(n,3)))/(k2+1/2*H(LNODES(n,1))...
     ...
     +1/2*H(LNODES(n,2))) (1/8*P(LNODES(n,1))+1/8*P(LNODES(n,2)))/(k2+1/2*H(LNODES(n,1))...
     +1/2*H(LNODES(n,2))) (1/8*P(LNODES(n,1))+1/8*P(LNODES(n,3)))/(k2+1/2*H(LNODES(n,1))...
     +1/2*H(LNODES(n,3)));(1/8*P(LNODES(n,1))+1/8*P(LNODES(n,2)))/(k2+1/2*H(LNODES(n,1))...
     +1/2*H(LNODES(n,2))) (1/8*P(LNODES(n,1))+1/8*P(LNODES(n,2)))/(k2+1/2*H(LNODES(n,1))...
     +1/2*H(LNODES(n,2)))+(1/8*P(LNODES(n,2))+1/8*P(LNODES(n,3)))/(k2+1/2*H(LNODES(n,2))...
     +1/2*H(LNODES(n,3))) (1/8*P(LNODES(n,2))+1/8*P(LNODES(n,3)))/(k2+1/2*H(LNODES(n,2))...
     +1/2*H(LNODES(n,3)));(1/8*P(LNODES(n,1))+1/8*P(LNODES(n,3)))/(k2+1/2*H(LNODES(n,1))...
     +1/2*H(LNODES(n,3))) (1/8*P(LNODES(n,2))+1/8*P(LNODES(n,3)))/(k2+1/2*H(LNODES(n,2))...
     +1/2*H(LNODES(n,3))) (1/8*P(LNODES(n,1))+1/8*P(LNODES(n,3)))/(k2+1/2*H(LNODES(n,1))...
     +1/2*H(LNODES(n,3)))+(1/8*P(LNODES(n,2))+1/8*P(LNODES(n,3)))/(k2+1/2*H(LNODES(n,2))...
     +1/2*H(LNODES(n,3)))];
