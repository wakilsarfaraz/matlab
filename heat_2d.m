...
NNODES = (N+1)^2;
QU = ones(NNODES,1);% This introduces the number of nodes in the result of triangulation.
QV = ones(NNODES,1);
...
%    Amass = (det(J)/60)*[6*r1(1)+2*r2(1)+2*r3(1) 2*r1(1)+2*r2(1)+r3(1) 2*r1(1)+r2(1)+2*r3(1);...
%        2*r1(1)+2*r2(1)+r3(1) 2*r1(1)+2*r2(1)+2*r3(1) r1(1)+2*r2(1)+2*r3(1);...
%        2*r1(1)+r2(1)+2*r3(1) r1(1)+2*r2(1)+2*r3(1)  2*r1(1)+2*r2(1)+2*r3(1)];
   
%       Amass = (det(J)/150)*[6*(r1+2*r2+2*r3)*(r1+2*r2+2*r3)' 2*(r1+2*r2+r3)*(r1+2*r2+r3)' (2*r1+r2+2*r3)*(2*r1+r2+2*r3)';...
...
%        (2*r1+r2+2*r3)*(2*r1+r2+2*r3)' (r1+2*r2+2*r3)*(r1+2*r2+2*r3)'  (2*r1+2*r2+2*r3)*(2*r1+2*r2+2*r3)'];
   ...
   Amass = (det(J)/60)*[6*r1(2)+2*r2(2)+2*r3(2) 2*r1(2)+2*r2(2)+r3(2) 2*r1(2)+r2(2)+2*r3(2);...
       2*r1(2)+2*r2(2)+r3(2) 2*r1(2)+2*r2(2)+2*r3(2) r1(2)+2*r2(2)+2*r3(2);...
       2*r1(2)+r2(2)+2*r3(2) r1(2)+2*r2(2)+2*r3(2)  2*r1(2)+2*r2(2)+2*r3(2)];
